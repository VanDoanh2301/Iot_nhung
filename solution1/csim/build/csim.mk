...
HLS_SOURCES = ../../../main.cpp ../../../tb_fir.cpp ../../../fir.cpp

override TARGET := csim.exe

AUTOPILOT_ROOT := D:/Vitis_vivado/Vitis/2020.1
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := D:/Vitis_vivado/Vitis/2020.1/tps/win64/msys64/mingw64/bin
endif
...
$(ObjDir)/tb_fir.o: ../../../tb_fir.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../tb_fir.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_fir.d
